...
const whyChooseUs = [
  { icon: MapPin, title: `Serving ${county.name}`, description: 'Full coverage across Kent, Ravenna, Aurora, and all surrounding communities.' },
...
export default function PortageCountyPage() {
  return (
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="bg-white rounded-2xl p-6 md:p-8 shadow-lg">
              ...
              <blockquote className="text-lg text-slate-700 italic mb-4">"We had a sump pump fail during a big storm. AK Water Works came out at 2am and saved our basement. Can't thank them enough!"</blockquote>
              <p className="text-slate-500">— Satisfied Customer, Kent, OH</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="bg-[var(--color-primary)] rounded-2xl overflow-hidden">
          <div className="grid lg:grid-cols-3">
            <div className="lg:col-span-2 h-64 lg:h-auto min-h-[300px]">
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d380797.9036880893!2d-81.2!3d41.15!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8831283d5a8c8c8f%3A0x4c4c4c4c4c4c4c4c!2sPortage%20County%2C%20OH!5e0!3m2!1sen!2sus!4v1704931200000!5m2!1sen!2sus" width="100%" height="100%" style={{ border: 0, minHeight: '300px' }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" title={`Map of ${county.name}, ${county.state}`} />
            </div>
