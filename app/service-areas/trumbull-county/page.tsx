...
const whyChooseUs = [
  {
    icon: MapPin,
    title: 'Local to Trumbull County',
    description: 'Based in Warren, we know the area and can respond quickly to any call.',
  },
  {
    icon: Clock,
...
export default function TrumbullCountyPage() {
  return (
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="bg-white rounded-2xl p-6 md:p-8 shadow-lg">
              ...
              <blockquote className="text-lg text-slate-700 italic mb-4">
                "AK Water Works fixed our basement flooding issue when no one else could. They're local, 
                they know the area, and they truly care about their customers. Highly recommend to anyone in {county.name}!"
              </blockquote>
              <p className="text-slate-500">— Satisfied Customer, Warren, OH</p>
            </div>
          </div>
        </div>
      </section>
