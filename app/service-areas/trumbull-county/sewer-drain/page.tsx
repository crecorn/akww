...
const services = [
  {
    ...
    description: 'Clear clogged sinks, tubs, showers, and floor drains quickly and effectively.',
    icon: Droplets,
  },
  {
    title: 'Sewer Line Repair',
    description: 'Expert repair and replacement, including trenchless options that save your yard.',
    icon: AlertTriangle,
  },
  {
    title: 'Camera Inspection',
    description: 'HD video inspection to locate blockages, damage, and assess pipe condition.',
    icon: Video,
  },
  {
    title: 'Hydro Jetting',
    description: 'High-pressure water jetting to blast away stubborn clogs and buildup.',
    icon: Waves,
  },
  {
    title: 'Root Removal',
    description: 'Remove tree roots from sewer lines and prevent regrowth.',
    icon: TreeDeciduous,
  },
  {
    title: '24/7 Emergency',
    description: 'Sewage backup? Main line clog? We respond immediately, any time.',
    icon: Clock,
  },
]

const benefits = [
  'Same-day drain service available',
...
export default function TrumbullSewerDrainPage() {
  return (
      ...
      <header className="bg-gradient-to-br from-[var(--color-primary)] to-blue-800 py-12 md:py-16 text-white">
        <div className="container mx-auto px-4">
          <div className="flex items-center gap-2 text-blue-200 mb-4">
            ...
            <span className="font-medium">Sewer & Drain Services</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-blue-100 mb-6 max-w-2xl">
            ...
            and expertise to solve any drain problem in {county.name}. Fast response, 
            upfront pricing, and guaranteed results.
          </p>
            ...
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-xl font-bold text-slate-900">
                  Warning Signs You Need Drain Service
                </h2>
      ...
      <section className="pb-12">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl font-bold text-slate-900 mb-4">
            Drain Service Throughout {county.name}
          </h2>
          <p className="text-slate-600 mb-6">
            We provide sewer and drain services to all cities in {county.name}:
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div>
              <h3 className="text-2xl font-bold text-white mb-6">
                Why Choose AK Water Works for Drain Service?
              </h3>
            ...
            <div className="bg-white rounded-2xl p-6 md:p-8 shadow-lg">
              ...
              <blockquote className="text-lg text-slate-700 italic mb-4">
                "Our main sewer line was backing up. AK Water Works used a camera to find the 
                problem - tree roots. They cleared it same day and the price was fair. Excellent work!"
              </blockquote>
              <p className="text-slate-500">— Customer in Niles, OH</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="grid lg:grid-cols-3">
              ...
              <div className="p-6 md:p-8 text-white flex flex-col justify-center">
                <h2 className="text-2xl md:text-3xl font-bold mb-3">
                  Drain Emergency in {county.name}?
                </h2>
                <p className="text-blue-100 mb-6">
                  We offer 24/7 emergency drain service. Call now for immediate help.
                </p>
                <div className="flex flex-col gap-3">
                  ...
                  <BookNowButton variant="primary" size="lg" service="Sewer & Drain">
                    Book Now
                  </BookNowButton>
                </div>
              </div>
