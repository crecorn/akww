...
const SERVICE_TYPES = [
  ...
  'Plumbing - Emergency',
  'Sewer & Drain - Clogged Drain',
  'Sewer & Drain - Sewer Line',
  'Sewer & Drain - Camera Inspection',
  'Waterproofing - Wet Basement',
  'Waterproofing - Foundation Crack',
...
export default function TrumbullContactPage() {
      ...
      <div className="container mx-auto px-4">
        ...
        <header className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-slate-900 mb-3">
            Request Service in {county.name}
          </h1>
        ...
        <div className="bg-red-50 border border-red-200 rounded-xl p-4 mb-8 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-red-700 text-sm mt-1">
              Don't wait - call us immediately for 24/7 emergency service in {county.name}.
            </p>
            <a 
            ...
            {submitStatus === 'success' ? (
              <div className="bg-green-50 border border-green-200 rounded-xl p-8 text-center">
                ...
                <p className="text-slate-600 mb-4">
                  We've received your service request for {county.name} and will contact you shortly.
                </p>
                <p className="text-sm text-slate-500">
                  For emergencies, call <a href={`tel:${county.phoneRaw}`} className="text-[var(--color-primary)] font-semibold">{county.phone}</a>
                </p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="bg-white rounded-xl p-6 shadow-sm border border-slate-200 space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={4}
                    placeholder="Please provide details about your plumbing, drain, or waterproofing issue..."
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200">
              ...
              <div className="space-y-4">
                <a href={`tel:${county.phoneRaw}`} className="flex items-center gap-3 text-slate-600 hover:text-[var(--color-primary)]">
                  <div className="p-2 bg-[var(--color-primary)]/10 rounded-lg">
                    <Phone className="w-5 h-5 text-[var(--color-primary)]" />
                  </div>
                  <div>
                    <p className="text-xs text-slate-500">{county.name} Direct Line</p>
                    <p className="font-semibold text-slate-900">{county.phone}</p>
                  </div>
                </a>
                ...
                <div className="flex items-start gap-3 text-slate-600">
                  ...
                  <div>
                    <p className="text-sm">Serving all of {county.name}</p>
                    <p className="text-xs text-slate-500 mt-1">Based in Warren, OH</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 text-slate-600">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">Always available when you need us</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="text-center">
              <img 
                ...
                alt="" 
                className="h-28 mx-auto opacity-75"
                aria-hidden="true"
              />
            </div>
          </div>
