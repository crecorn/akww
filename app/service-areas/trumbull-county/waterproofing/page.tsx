...
const services = [
  {
    ...
    description: 'French drains, sump pumps, and interior drainage systems.',
    icon: Home,
  },
  {
    title: 'Exterior Waterproofing',
    description: 'Excavation and waterproof membrane application.',
    icon: Shield,
  },
  {
    title: 'Foundation Crack Repair',
    description: 'Epoxy injection and carbon fiber reinforcement.',
    icon: Construction,
  },
  {
    title: 'Sump Pump Installation',
    description: 'Primary and backup sump pump systems.',
    icon: Droplets,
  },
  {
    title: 'Crawl Space Encapsulation',
    description: 'Moisture barrier and dehumidification systems.',
    icon: Home,
  },
  {
    title: 'Emergency Water Removal',
    description: '24/7 response for flooded basements.',
    icon: Clock,
  },
]
...
const benefits = [
  ...
  'Locally owned - we know Ohio basements',
...
export default function TrumbullWaterproofingPage() {
  return (
      ...
      <header className="bg-gradient-to-br from-[var(--color-primary)] to-blue-800 py-12 md:py-16 text-white">
        <div className="container mx-auto px-4">
          <div className="flex items-center gap-2 text-blue-200 mb-4">
            ...
            <span className="font-medium">Waterproofing Services</span>
          </div>
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
            Basement Waterproofing in {county.name}, {county.state}
          </h1>
          <p className="text-lg md:text-xl text-blue-100 mb-6 max-w-2xl">
            Protect your home from water damage with professional basement waterproofing 
            and foundation repair. We've helped hundreds of {county.name} homeowners 
            keep their basements dry and their foundations strong.
          </p>
      ...
      <section className="pb-12">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl font-bold text-slate-900 mb-4">
            Why {county.name} Homes Need Waterproofing
          </h2>
          <p className="text-slate-600 mb-4">
            Northeast Ohio's climate creates unique challenges for basements. Heavy rain, 
            snowmelt, and high water tables in {county.name} can lead to water intrusion 
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div>
              <h3 className="text-2xl font-bold text-white mb-6">
                Why Choose AK Water Works for Waterproofing?
              </h3>
            ...
            <div className="bg-white rounded-2xl p-6 md:p-8 shadow-lg">
              ...
              <blockquote className="text-lg text-slate-700 italic mb-4">
                "Our basement flooded every spring. AK Water Works installed a French drain 
                and sump pump system, and we haven't had a drop of water since. They really 
                know what they're doing!"
              </blockquote>
              <p className="text-slate-500">— Customer in Cortland, OH</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="grid lg:grid-cols-3">
              ...
              <div className="p-6 md:p-8 text-white flex flex-col justify-center">
                ...
                <p className="text-blue-100 mb-6">
                  We'll inspect your basement and provide a detailed quote with no obligation.
                </p>
                <div className="flex flex-col gap-3">
                  ...
                  <BookNowButton variant="primary" size="lg" service="Waterproofing">
                    Book Now
                  </BookNowButton>
                </div>
              </div>
