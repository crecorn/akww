...
const services = [
  {
    ...
    description: 'Complete residential and commercial plumbing repairs, installations, and maintenance.',
    href: `/service-areas/${county.slug}/plumbing`,
    icon: Wrench,
    features: ['Water Heaters', 'Pipe Repair', 'Fixture Installation', 'Emergency Service'],
  },
  {
    title: 'Sewer & Drain',
    description: 'Professional drain cleaning, sewer repair, and camera inspection services.',
    href: `/service-areas/${county.slug}/sewer-drain`,
    icon: Droplets,
    features: ['Drain Cleaning', 'Sewer Repair', 'Hydro Jetting', 'Camera Inspection'],
  },
  {
    title: 'Waterproofing',
    description: 'Protect your basement and foundation from water damage with our waterproofing solutions.',
    href: `/service-areas/${county.slug}/waterproofing`,
    icon: Home,
    features: ['Basement Waterproofing', 'Foundation Repair', 'Sump Pumps', 'French Drains'],
  },
]
...
const whyChooseUs = [
  {
    icon: MapPin,
    title: `Serving ${county.name}`,
    description: 'Full coverage across Youngstown, Boardman, Canfield, and all surrounding communities.',
  },
  {
    icon: Clock,
    title: '24/7 Emergency Service',
    description: 'Plumbing emergencies don\'t wait. Neither do we. Call anytime.',
  },
  {
    icon: Shield,
...
export default function MahoningCountyPage() {
  return (
    <div className="space-y-12 py-8">
          ...
          <div className="relative flex flex-col lg:flex-row lg:items-center gap-8">
            <div className="flex-1">
              <div className="flex items-center gap-2 text-blue-200 mb-4">
                ...
                <span className="font-medium">Proudly Serving {county.name}</span>
              </div>
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
                Your Trusted Plumber in {county.name}, {county.state}
              </h1>
            ...
            <div className="hidden lg:flex w-80 self-stretch bg-white/10 rounded-xl border-2 border-dashed border-white/30 items-center justify-center">
              <div className="text-center text-white/50">
                <div className="w-16 h-16 mx-auto mb-2 rounded-lg bg-white/10 flex items-center justify-center">
            ...
            return (
              ...
              >
                <div className="flex items-center gap-4 mb-4">
                  <div className="p-3 bg-[var(--color-primary)]/10 rounded-lg group-hover:bg-[var(--color-primary)] transition-colors">
                    <Icon className="w-6 h-6 text-[var(--color-primary)] group-hover:text-white transition-colors" />
                  </div>
                  <h3 className="text-xl font-bold text-slate-900 group-hover:text-[var(--color-primary)] transition-colors">
                    {service.title}
                  </h3>
                </div>
                ...
                <div className="mt-4 flex items-center gap-1 text-[var(--color-primary)] font-medium group-hover:gap-2 transition-all">
      ...
      <section className="bg-slate-900 py-12">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl font-bold text-white mb-4">
            Cities & Areas We Serve in {county.name}
          </h2>
          <p className="text-slate-300 mb-6">
            We provide fast, reliable service throughout {county.name}. Our service area includes:
          </p>
          <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
            {county.cities.map((city) => (
              <div key={city} className="flex items-center gap-2 text-slate-200">
          ...
          <div className="mt-6 pt-6 border-t border-slate-700">
            <h3 className="font-semibold text-white mb-3">Townships:</h3>
            <div className="flex flex-wrap gap-2">
              {county.townships.map((township) => (
                <span 
                  key={township}
      ...
      <section className="container mx-auto px-4">
        <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-6">
          Why {county.name} Trusts AK Water Works
        </h2>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {whyChooseUs.map((item) => {
            const Icon = item.icon
            return (
              <div key={item.title} className="bg-white rounded-xl p-5 shadow-sm border border-slate-200">
                <div className="p-2 bg-[var(--color-accent)]/10 rounded-lg w-fit mb-3">
      ...
      {/* Why We're the Best + Reviews Combined */}
      <section className="bg-[var(--color-accent)] py-12">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            {/* Left - Highlights */}
            <div>
              <h3 className="text-2xl font-bold text-white mb-6">Why We're the Best Choice for {county.name}</h3>
            ...
            <div className="bg-white rounded-2xl p-6 md:p-8 shadow-lg">
              ...
              <blockquote className="text-lg text-slate-700 italic mb-4">
                "Had a major pipe burst in our Boardman home. AK Water Works was here within the hour 
                and had everything fixed that same day. Professional, fair pricing, and great work!"
              </blockquote>
              <p className="text-slate-500">— Satisfied Customer, Boardman, OH</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-3">
            ...
            <div className="p-6 md:p-8 text-white flex flex-col justify-center">
              ...
              <p className="text-blue-100 mb-6">
                Whether it's a plumbing emergency or scheduled maintenance, we're here to help.
