...
import { Waves, BookOpen, CheckCircle2, ArrowRight, Phone, AlertTriangle, Clock } from 'lucide-react'
    ...
    <div className="space-y-12">
      ...
      <section>
        ...
        <p className="text-center text-slate-500 mt-6 text-sm">
          ...
          <Link href="/emergencies/contact" className="text-[var(--color-primary)] font-medium hover:underline">
            Contact us
          </Link>{' '}
