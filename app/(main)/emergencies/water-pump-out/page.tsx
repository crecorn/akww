...
import {
  ...
  Droplets, Home, Gauge, AlertTriangle
} from 'lucide-react'
import { siteConfig } from '@/lib/constants/site'
import { useBooking } from '@/components/providers/booking-provider'

const services = [
  { icon: Droplets, title: 'Rapid Water Removal', desc: 'Powerful extraction equipment' },
  { icon: Gauge, title: 'Truck-Mounted Pumps', desc: 'High-volume water removal' },
  { icon: Home, title: 'Basement Specialists', desc: 'Flooded basement experts' },
  { icon: Shield, title: 'Damage Prevention', desc: 'Stop secondary damage' },
]
...
const benefits = [
  ...
  'Carpet & hardwood extraction',
  'Immediate drying begins',
]

const signs = [
  'Standing water in basement',
  'Burst pipe flooding',
  'Appliance leak or failure',
...
const faqs = [
  {
    q: 'How quickly can you pump out water?',
    a: 'Our truck-mounted pumps can remove hundreds of gallons per minute. Most residential basements can be pumped out within 1-2 hours.'
  },
  {
    q: 'Do you just pump out water or do you dry too?',
    a: 'We do both! After pumping out standing water, we set up air movers and dehumidifiers to thoroughly dry your property and prevent mold growth.'
  },
  {
    q: 'How much does water pump out cost?',
    a: 'Pricing depends on the volume of water and size of the affected area. We provide upfront pricing before starting work, and we work with insurance companies.'
  },
  {
    q: 'Can you help with insurance claims?',
    a: 'Yes! We document everything and work directly with your insurance company. We can bill them directly in most cases.'
  },
]

export default function WaterPumpOutPage() {
    ...
    <div className="space-y-8">
      ...
      <section className="bg-red-600 text-white rounded-2xl p-6 text-center">
        <div className="flex items-center justify-center gap-3 mb-3">
          ...
          <span className="text-xl font-bold">Flooded? We Pump It Out Fast!</span>
        </div>
        <a
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white rounded-2xl overflow-hidden p-6 md:p-10">
        ...
        <div className="relative">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
            ...
            <span className="text-sm font-medium">Water Pump Out</span>
          </div>

          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            Standing Water?
            <span className="block text-[var(--color-accent)]">We Pump It Out Fast.</span>
          </h1>

          <p className="text-xl text-slate-300 mb-8 max-w-2xl">
            Powerful truck-mounted pumps and extraction equipment remove water fast.
            60-minute response to minimize damage and start drying immediately.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <button
              onClick={() => openBooking('Water Pump Out')}
      ...
      <section className="bg-[var(--color-primary)] rounded-2xl p-6 md:p-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-white">
            ...
            <p className="text-blue-100">Standing water causes damage fast. Call now for immediate pump out.</p>
          </div>
          <a
            href={`tel:${siteConfig.phoneRaw}`}
      ...
      <section className="bg-slate-900 text-white rounded-2xl p-6 md:p-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            { step: '2', title: 'Pump Out', desc: 'Remove standing water' },
            { step: '3', title: 'Extract', desc: 'Carpet & floor extraction' },
      ...
      <section className="bg-slate-900 text-white rounded-2xl p-6 md:p-10">
        <div className="text-center">
          ...
          <p className="text-xl text-slate-300 mb-8 max-w-xl mx-auto">
            Don&apos;t let standing water destroy your property.
            Call now for fast water pump out service.
          </p>
