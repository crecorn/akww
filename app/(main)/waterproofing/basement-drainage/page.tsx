...
const services = [
  { icon: ArrowDownToLine, title: 'French Drains', desc: 'Interior drain systems' },
  { icon: Waves, title: 'Perimeter Drains', desc: 'Full basement coverage' },
  { icon: Home, title: 'Sump Basins', desc: 'Water collection & pump' },
  { icon: Wrench, title: 'Drain Tile Repair', desc: 'Fix existing systems' },
]
...
const signs = [
  ...
  'Water seeping along walls',
  'Existing drains not working',
  'Clogged or failed sump',
...
export default function BasementDrainagePage() {
    ...
    <div className="space-y-8">
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white rounded-2xl overflow-hidden p-6 md:p-10">
        ...
        <div className="relative">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
            ...
            <span className="text-sm font-medium">Basement Drainage</span>
          </div>

          {/* Heading */}
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            French Drains &
            <span className="block text-[var(--color-accent)]">Drainage Systems.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <button
              onClick={() => openBooking('Basement Drainage')}
            ...
            >
              <div className="aspect-square bg-slate-200 rounded-xl overflow-hidden flex items-center justify-center border-2 border-dashed border-slate-300">
                <div className="text-center text-slate-400 p-4">
                  <ArrowDownToLine className="w-8 h-8 mx-auto mb-2 text-slate-300" />
                  <span className="text-xs">Drainage {num}</span>
                </div>
              </div>
            </div>
          ))}
      ...
      <section className="bg-[var(--color-primary)] rounded-2xl p-6 md:p-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-white">
            <h2 className="text-2xl font-bold mb-1">Water Pooling in Your Basement?</h2>
            <p className="text-blue-100">A French drain system can solve that problem permanently.</p>
          </div>
          <a
            href={`tel:${siteConfig.phoneRaw}`}
      ...
      <section className="bg-slate-900 text-white rounded-2xl p-6 md:p-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { step: '1', title: 'Assess', desc: 'Evaluate water entry' },
            { step: '2', title: 'Design', desc: 'Custom drain layout' },
            { step: '3', title: 'Install', desc: 'Professional work' },
            { step: '4', title: 'Dry!', desc: 'No more water' },
          ].map((item) => (
