...
const services = [
  { icon: Home, title: 'Interior Waterproofing', desc: 'Inside protection systems' },
  { icon: Shield, title: 'Exterior Waterproofing', desc: 'Outside barrier systems' },
  { icon: Wrench, title: 'Crack Repair', desc: 'Foundation crack sealing' },
  { icon: Droplets, title: 'Sump Pumps', desc: 'Installation & service' },
]
...
const benefits = [
  ...
  'Prevent mold & structural damage',
]
    ...
    <div className="space-y-8">
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white rounded-2xl overflow-hidden p-6 md:p-10">
        ...
        <div className="relative">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
            ...
            <span className="text-sm font-medium">Basement Waterproofing</span>
          </div>

          {/* Heading */}
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            Wet Basement?
            <span className="block text-[var(--color-accent)]">Keep It Dry Forever.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <button
              onClick={() => openBooking('Basement Waterproofing')}
      ...
      <section className="bg-[var(--color-primary)] rounded-2xl p-6 md:p-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-white">
            <h2 className="text-2xl font-bold mb-1">Get a Free Basement Inspection</h2>
            <p className="text-blue-100">We&apos;ll diagnose the problem and provide a no-obligation quote.</p>
          </div>
          <a
            href={`tel:${siteConfig.phoneRaw}`}
      ...
      <section className="bg-slate-900 text-white rounded-2xl p-6 md:p-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { step: '1', title: 'Free Inspection', desc: 'We assess your basement' },
            { step: '2', title: 'Custom Plan', desc: 'Solution for your home' },
            { step: '3', title: 'Install', desc: 'Professional installation' },
            { step: '4', title: 'Dry Forever', desc: 'Lifetime warranty' },
          ].map((item) => (
