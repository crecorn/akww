...
import { 
  ...
  Flame, Zap, ThermometerSun, Wrench, AlertTriangle
} from 'lucide-react'
import { siteConfig } from '@/lib/constants/site'
import { useBooking } from '@/components/providers/booking-provider'

const services = [
  { icon: Wrench, title: 'Water Heater Repair', desc: 'Fast fixes for any issue' },
  { icon: Flame, title: 'Tank Installation', desc: 'Traditional water heaters' },
  { icon: Zap, title: 'Tankless Installation', desc: 'Endless hot water on demand' },
  { icon: ThermometerSun, title: 'Maintenance', desc: 'Extend your unit\'s life' },
]
...
const faqs = [
  { 
    ...
    a: 'Tank water heaters typically last 8-12 years. Tankless units can last 20+ years with proper maintenance.' 
  },
  { 
    q: 'Should I repair or replace?', 
    a: 'If your unit is over 10 years old and needs major repairs, replacement is usually more cost-effective.' 
  },
  { 
    q: 'Tank vs. tankless—which is better?', 
    a: 'Tankless costs more upfront but saves energy and provides endless hot water. We\'ll help you decide.' 
  },
  { 
    q: 'How long does installation take?', 
    a: 'Most water heater installations are completed in 2-4 hours.' 
  },
]
    ...
    <div className="space-y-8">
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white rounded-2xl overflow-hidden p-6 md:p-10">
        ...
        <div className="relative">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
            ...
            <span className="text-sm font-medium">Water Heater Services</span>
          </div>

          {/* Heading */}
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            No Hot Water?
            <span className="block text-[var(--color-accent)]">We Can Fix That.</span>
          </h1>

          {/* Subheading */}
          <p className="text-xl text-slate-300 mb-8 max-w-2xl">
            Same-day water heater repair and installation. Tank or tankless, 
            we service all brands and get your hot water flowing fast.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <button
              onClick={() => openBooking('Water Heater Service')}
            ...
            >
              <div className="aspect-square bg-slate-200 rounded-xl overflow-hidden flex items-center justify-center border-2 border-dashed border-slate-300">
                <div className="text-center text-slate-400 p-4">
                  <Flame className="w-8 h-8 mx-auto mb-2 text-slate-300" />
                  <span className="text-xs">Water Heater {num}</span>
                </div>
              </div>
            </div>
          ))}
      ...
      <section className="bg-[var(--color-primary)] rounded-2xl p-6 md:p-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-white">
            <h2 className="text-2xl font-bold mb-1">Need Hot Water Today?</h2>
            <p className="text-blue-100">Call now for same-day water heater service.</p>
          </div>
          <a
            href={`tel:${siteConfig.phoneRaw}`}
      ...
      <section className="bg-slate-900 text-white rounded-2xl p-6 md:p-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { step: '1', title: 'Call Us', desc: 'Describe your issue' },
            { step: '2', title: 'We Diagnose', desc: 'Inspect your unit' },
            { step: '3', title: 'Get Options', desc: 'Repair or replace' },
            { step: '4', title: 'Hot Water!', desc: 'Fast, quality work' },
          ].map((item) => (
        ...
        <div className="mt-8 flex items-center gap-4 bg-slate-800 rounded-xl p-4">
          ...
          <div className="flex-1">
            <p className="text-slate-300">
              <strong className="text-white">Jack says:</strong> &quot;Don&apos;t wait for a cold shower! 
              Call now and we&apos;ll get your hot water back fast.&quot;
            </p>
          </div>
          <button
            onClick={() => openBooking('Water Heater Service')}
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 text-white">
            <blockquote className="text-lg italic mb-2">
              &quot;Water heater died on a Saturday. AK Water Works came out same day 
              and had a new one installed by evening. Great service!&quot;
            </blockquote>
            <p className="font-semibold">— Mike R., Warren, OH</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-slate-900 text-white rounded-2xl p-6 md:p-10">
        <div className="text-center">
          ...
          <p className="text-xl text-slate-300 mb-8 max-w-xl mx-auto">
            Don&apos;t suffer through cold showers. Call now or book online 
            for fast, professional water heater service.
          </p>
