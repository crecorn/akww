...
import { 
  ...
  Siren, Droplets, Flame, AlertTriangle, Wrench
} from 'lucide-react'
import { siteConfig } from '@/lib/constants/site'
import { useBooking } from '@/components/providers/booking-provider'

const services = [
  { icon: Droplets, title: 'Burst Pipes', desc: 'Stop flooding fast' },
  { icon: Flame, title: 'No Hot Water', desc: 'Water heater failures' },
  { icon: AlertTriangle, title: 'Sewer Backups', desc: 'Clear blockages now' },
  { icon: Wrench, title: 'Major Leaks', desc: 'Find and fix fast' },
]
...
const faqs = [
  { 
    ...
    a: 'For true emergencies, we typically arrive within 30-60 minutes, depending on your location and time of day.' 
  },
  { 
    q: 'Is there an extra charge for emergencies?', 
    a: 'We have a service call fee for after-hours emergencies, but our repair rates stay fair. You\'ll get upfront pricing before we start any work.' 
  },
  { 
    q: 'What qualifies as a plumbing emergency?', 
    a: 'Burst pipes, major leaks, sewer backups, no water, flooding, and gas leaks are all emergencies. When in doubt, call us.' 
  },
  { 
    q: 'What should I do while waiting?', 
    a: 'Shut off your main water valve if possible. This stops the flow and prevents further damage. We\'ll guide you through it on the phone.' 
  },
]
    ...
    <div className="space-y-8">
      ...
      <section className="bg-red-600 text-white rounded-2xl p-6 text-center">
        <div className="flex items-center justify-center gap-3 mb-3">
          ...
          <span className="text-xl font-bold">Plumbing Emergency? We&apos;re Available 24/7!</span>
          <Siren className="w-7 h-7 animate-pulse" />
        </div>
        <a
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white rounded-2xl overflow-hidden p-6 md:p-10">
        ...
        <div className="relative">
          ...
          <p className="text-xl text-slate-300 mb-8 max-w-2xl">
            Plumbing emergencies don&apos;t wait, and neither do we. Fast response, 
            expert repairs, any hour of the day or night. Call now.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <button
              onClick={() => openBooking('Emergency Plumbing')}
      ...
      <section className="bg-red-600 rounded-2xl p-6 md:p-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-white">
            ...
            <p className="text-red-100">Don&apos;t let water damage get worse. Call now.</p>
          </div>
          <a
            href={`tel:${siteConfig.phoneRaw}`}
      ...
      <section className="bg-slate-900 text-white rounded-2xl p-6 md:p-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            { step: '3', title: 'Assess', desc: 'Upfront pricing' },
            { step: '4', title: 'Fix It!', desc: 'Same-day repairs' },
          ].map((item) => (
        ...
        <div className="mt-8 flex items-center gap-4 bg-slate-800 rounded-xl p-4">
          ...
          <div className="flex-1">
            <p className="text-slate-300">
              <strong className="text-white">Jack says:</strong> &quot;I know emergencies are stressful. 
              That&apos;s why we get there fast and fix it right. You&apos;re in good paws!&quot;
            </p>
          </div>
          <a
            href={`tel:${siteConfig.phoneRaw}`}
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 text-white">
            <blockquote className="text-lg italic mb-2">
              &quot;Pipe burst at 2 AM on a Sunday. They answered immediately and 
              had a plumber here within 45 minutes. Saved us from major damage!&quot;
            </blockquote>
            <p className="font-semibold">— Dave & Mary L., Warren, OH</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-red-600 text-white rounded-2xl p-6 md:p-10">
        <div className="text-center">
          ...
          <p className="text-xl text-red-100 mb-8 max-w-xl mx-auto">
            Plumbing emergencies get worse by the minute. 
