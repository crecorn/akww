...
import { 
  ...
  Construction, Wrench, Video, TreeDeciduous, AlertTriangle
} from 'lucide-react'
import { siteConfig } from '@/lib/constants/site'
import { useBooking } from '@/components/providers/booking-provider'

const services = [
  { icon: Video, title: 'Camera Inspection', desc: 'See the problem clearly' },
  { icon: Wrench, title: 'Pipe Repair', desc: 'Fix cracks & damage' },
  { icon: Construction, title: 'Trenchless Repair', desc: 'No digging required' },
  { icon: TreeDeciduous, title: 'Line Replacement', desc: 'Full sewer line install' },
]
...
const faqs = [
  { 
    ...
    a: 'Trenchless repair fixes your sewer line without digging up your entire yard. We use pipe lining or pipe bursting techniques that only require small access points.' 
  },
  { 
    q: 'How do I know if my sewer line is damaged?', 
    a: 'Signs include multiple slow drains, sewage backups, gurgling sounds, sewage smells, wet spots in the yard, and recurring clogs despite drain cleaning.' 
  },
  { 
    q: 'How long does sewer line repair take?', 
    a: 'Most repairs are completed in 1-2 days. Trenchless repairs often take just a few hours. Full replacements may take 2-3 days.' 
  },
  { 
    q: 'Will you dig up my yard?', 
    a: 'Not necessarily! We offer trenchless options for many situations. When digging is needed, we minimize disruption and restore the area when finished.' 
  },
]
    ...
    <div className="space-y-8">
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white rounded-2xl overflow-hidden p-6 md:p-10">
        ...
        <div className="relative">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
            ...
            <span className="text-sm font-medium">Sewer Line Repair</span>
          </div>

          {/* Heading */}
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            Sewer Line Problems?
            <span className="block text-[var(--color-accent)]">We Fix Them Right.</span>
          </h1>

          {/* Subheading */}
          <p className="text-xl text-slate-300 mb-8 max-w-2xl">
            Expert sewer line repair and replacement. Trenchless options save your yard. 
            Camera inspection shows you exactly what&apos;s wrong.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <button
              onClick={() => openBooking('Sewer Line Repair')}
            ...
            >
              <div className="aspect-square bg-slate-200 rounded-xl overflow-hidden flex items-center justify-center border-2 border-dashed border-slate-300">
                <div className="text-center text-slate-400 p-4">
                  <Construction className="w-8 h-8 mx-auto mb-2 text-slate-300" />
                  <span className="text-xs">Sewer Work {num}</span>
                </div>
              </div>
            </div>
          ))}
      ...
      <section className="bg-[var(--color-primary)] rounded-2xl p-6 md:p-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-white">
            <h2 className="text-2xl font-bold mb-1">Think You Have a Sewer Problem?</h2>
            <p className="text-blue-100">Camera inspection finds the issue fast—no guessing.</p>
          </div>
          <a
            href={`tel:${siteConfig.phoneRaw}`}
      ...
      <section className="bg-slate-900 text-white rounded-2xl p-6 md:p-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { step: '1', title: 'Call Us', desc: 'Describe your symptoms' },
            { step: '2', title: 'Camera Inspect', desc: 'See the problem' },
            { step: '3', title: 'Get Options', desc: 'Trenchless or traditional' },
            { step: '4', title: 'Fixed!', desc: 'Quality repair work' },
          ].map((item) => (
        ...
        <div className="mt-8 flex items-center gap-4 bg-slate-800 rounded-xl p-4">
          ...
          <div className="flex-1">
            <p className="text-slate-300">
              <strong className="text-white">Jack says:</strong> &quot;Trenchless repair means 
              you keep your yard! Ask us if it&apos;s right for your situation.&quot;
            </p>
          </div>
          <button
            onClick={() => openBooking('Sewer Line Repair')}
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 text-white">
            <blockquote className="text-lg italic mb-2">
              &quot;Needed sewer line replaced but dreaded the mess. They used trenchless 
              repair—barely any digging. Yard looks great and sewer works perfectly!&quot;
            </blockquote>
            <p className="font-semibold">— Robert K., Warren, OH</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-slate-900 text-white rounded-2xl p-6 md:p-10">
        <div className="text-center">
          ...
          <p className="text-xl text-slate-300 mb-8 max-w-xl mx-auto">
            Don&apos;t let sewer problems get worse. Call now for a 
            camera inspection and expert repair options.
          </p>
