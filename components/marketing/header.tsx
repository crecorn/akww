...
const navigation = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'Water Pump Out & Clean Up', href: '/emergencies/water-pump-out', description: 'Emergency removal' },
      { name: 'Burst Pipe Flooding', href: '/emergencies/burst-pipe-flooding', description: 'Rapid response' },
      { name: 'Storm Damage Recovery', href: '/emergencies/storm-damage-recovery', description: 'Weather-related damage' },
      { name: 'Decontamination', href: '/emergencies/decontamination-services', description: 'Sanitization services' },
  ...
  },
  {
    ...
    href: '/waterproofing',
    children: [
      { name: 'Basement Waterproofing', href: '/waterproofing/basement-waterproofing', description: 'Interior & exterior solutions' },
      { name: 'Basement Drainage', href: '/waterproofing/basement-drainage', description: 'French drains & perimeter systems' },
      { name: 'Crawl Space Encapsulation', href: '/waterproofing/crawl-space-encapsulation', description: 'Vapor barriers & drainage' },
      { name: 'Foundation Crack Repair', href: '/waterproofing/foundation-crack-repair', description: 'Wall & floor crack sealing' },
      { name: 'Sump Pump Services', href: '/waterproofing/sump-pump-services', description: 'Installation & repair' },
